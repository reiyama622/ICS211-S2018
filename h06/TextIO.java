...
public class TextIO {
   ...
   *          requires fewer then this number of characters, then extra spaces are
   *          added to the front of x to bring the total up to minChars. If
   *          minChars is less than or equal to zero, then x will be printed in
   *          the minimum number of spaces possible.
   */
