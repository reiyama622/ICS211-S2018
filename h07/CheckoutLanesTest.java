...
public class CheckoutLanesTest {
  ...
  public void testOneExpress() {
    ...
    assertTrue(shoppers.get(0).getNumberOfItems() == 10);
    assertTrue(shoppers.get(1).getNumberOfItems() == 5);
    assertTrue(shoppers.get(2).getNumberOfItems() == 25);
  ...
  public void testOneTwo() {
    ...
    assertTrue(shoppers.get(1).getNumberOfItems() == 20);
    assertTrue(shoppers.get(2).getNumberOfItems() == 15);
    assertTrue(shoppers.get(3).getNumberOfItems() == 17);
  }
