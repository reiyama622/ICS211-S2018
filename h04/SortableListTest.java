...
public class SortableListTest {
  ...
  public void testGet() {
    ...
    assertTrue("wrong get", list.get(1) == 2);
    try {
      assertEquals("Illegal index", list.get(8));
  ...
  public void testSet() {
    ...
    try {
      assertEquals("Illegal index", list.set(8, 5));
    } catch (IndexOutOfBoundsException e) {
      System.err.println("Index out of Bounds");
    }
  }
  ...
  public void testIndexOf() {
    ...
    assertTrue("not in the list", list.indexOf(8) == -1);
  }
  ...
  public void testRemove() {
    ...
    try {
      assertEquals("Illegal index", list.remove(8));
    } catch (IndexOutOfBoundsException e) {
      System.err.println("Index out of Bounds");
    }
  }
