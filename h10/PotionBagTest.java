...
public class PotionBagTest {
  ...
  public void test() {
    ...
    System.out.println("Q store: " + quickStoreTime + ", M store: " + medStoreTime + ", S store: " + slowStoreTime);
    ...
    System.out.println(
        "Q retrieve: " + quickRetrieveTime + ", M retrieve: " + medRetrieveTime + ", S retrieve: " + slowRetrieveTime);
  }
